...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Post.objects.create(author=u, title="Welcome to My Blog", content="اولین پست آزمایشی!", is_published=True)
        Post.objects.create(author=u, title="Django CMS", content="پروژه CMS جنگو با قابلیت توسعه به REST API.", is_published=True)
